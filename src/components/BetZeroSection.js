  ...
  return (
    <div className="f20">
      {videoView ? (
              ...
              <VideoComponent source={videobg} autoplay={true} loop={true} muted={true} approximateNumber={approximateNumber()} videoView={videoView} />
      ) : null}
      ...
      <div className="f21">
        <div className="f24">
          <div className="f26">
            {" "}
            Predict which numbers NOT will appear in the draw. <br />
              ...
              return (
                <div
                  ...
                  style={{
                    ...
                    border: `3px solid ${isSelected ? "white" : color}`,
                  }}
      ...
      >
        {selectedBalls.length > 0 && (
          <>
            Bet that the numbers {formatSelectedBalls()} would NOT be in the
            next draw
          </>
        )}
      </div>
      ...
      <div className="f23">
        <div className="f35">
          <div className="f36">
            ...
            >
              ...
              >
                ...
                >
                  <div className="button1" style={{ height: "16px" }}>
                    <BsFillCaretUpFill fontSize="14px" />
                  </div>
                  <div className="button1" style={{ height: "16px" }}>
                    <BsFillCaretDownFill fontSize="14px" />
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="f36">
            ...
            <div
              style={{ display: "flex", gap: "1px", alignItems: "center" }}
              onMouseEnter={Visibility1}
              onMouseLeave={Visibility1}
            >
              <input
                className="f39"
                type="text"
              ...
              >
                <div
                  style={{
                    display: `${isVisible1 === true ? "flex" : "none"}`,
                    flexDirection: "column",
                  }}
                >
                  <div className="button1" style={{ height: "16px" }}>
        ...
        <div className="f35">
          <div className="f36">
            Max Payout
            <div className="f40">
              <input className="f37" type="text" value={inputValue3} />
            </div>
          </div>
          <div className="f36">
            Total stake
